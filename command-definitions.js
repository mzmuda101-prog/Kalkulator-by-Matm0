        ...
        graph: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { syntax: 'krawędźL=x;y  /  krawędźP=x;y', command: 'kamera=0;0 {PIPE} kąt=90 {PIPE} krawędźP=10;0', description: 'celuj przez KRANIEC widoku: podajesz, gdzie ma trafić jeden brzeg pola (L = lewy, P = prawy), a oś i ułożenie stożka dolicza parser. Zasięg = odległość do tego punktu, o ile nie podasz zasięg=. Idealne, gdy znasz realną granicę kadru (róg ogrodzenia, brama), nie stopnie.' },
